...
public class Templo01 extends JFrame {
...
public Templo01() {
    ...
    Icon Pegar_Imagem = new ImageIcon("src\\ImagemTemplo01\\botao.png ");
    ...
    setVisible(true);
    setResizable(false);
    Templo01.EscolhaBotao executar = new Templo01.EscolhaBotao();
