...
public class JanelasT2P2 extends JFrame{
...
public JanelasT2P2() {
    ...
    add(new FaseT2P2());//Vai criar uma fase na janela
    setTitle("Casa 01 - Se Senão");// Este método setTitle vai permiti que seja criado um titulo para a tela.
    ...
    setSize(1366,768);// Este método vai criar o tamalho da janela, neste caso x=coluna e y=linha, nesta ordem
