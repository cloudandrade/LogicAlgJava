...
public class PersonagemTemplo01 extends JFrame{
    ...
    public PersonagemTemplo01() { // Terá que criar um cnstrutor para que a imagem apareça e o local onde ela vai ficar na tela. 
    ...
    public void andar(){ //Criar um metodo para que o personagegm ande na tela.
       ...
       if (Coord_P_x>=1792){ // Para não ultrapassar a parede direita.//1151
       Coord_P_x=1792-1;  
       }
//-------------Escolha PORTA ------------
...
//-------------Escolha SAIDA ------------
        ...
        if ((Coord_P_x>=30) && (Coord_P_x<=144)&& (enter==1)){ 
...
>>>>>>> 1677b1e294d1feb801ab373aa50c04188136bc4e
    ...
    if (botao_escolhido == KeyEvent.VK_LEFT){//Se for igual a seta para esquerda.
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagemTemplo01\\personagem_esquerda.gif"); 
    ...
    if (botao_escolhido == KeyEvent.VK_RIGHT){//Se for igual a seta para diraita
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagemTemplo01\\personagem_direita.gif"); 
        imagempersonagem = imagem_pasta.getImage();    
    }  
    ...
    if (botao_escolhido == KeyEvent.VK_LEFT){//Se for igual a seta para esquerda.
        ...
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagemTemplo01\\esquerda.png"); 
        imagempersonagem = imagem_pasta.getImage();        
    }
    if (botao_escolhido == KeyEvent.VK_RIGHT){//Se for igual a seta para diraita
        Coord_M_x = 0; // Se o usuario for para direita a posição que ele esta vai aumentar.
        ImageIcon imagem_pasta = new ImageIcon("src\\ImagemTemplo01\\direito.png"); 
        imagempersonagem = imagem_pasta.getImage();        
